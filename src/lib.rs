...
#[derive(Debug)]
pub struct MetaSpectraProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MetaSpectraProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MetaSpectra processing");
    
    let mut processor = MetaSpectraProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MetaSpectraProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MetaSpectraProcessor::new(false);
